...
pi <- subset(pi_1, subset = '2025-07-01 0:00', operator = '<')    
...
ss <- subset(ss_1, subset = '2025-07-01 0:00', operator = '<')
...
fm <- subset(fm_1, subset = '2025-07-01 0:00', operator = '<')
...
pc <- subset(pc_1, subset = '2025-07-01 0:00', operator = '<')
...
MET <- subset(MET_1, subset = '2025-07-01 0:00', operator = '<')
